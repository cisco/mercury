...
double http_request_cycles(size_t iterations, datum d) {
    ...
    // fprintf(stderr, "mean cycles: %f +/- ?\n", s.mean());
    // fprintf(stderr, "mean cycles: %f +/- %f\n", s.mean(), s.standard_deviation());
...
int main() {
    ...
    benchmark::mean_and_standard_deviation ms;
    ms += 1000000001;
    ms += 1000000002;
    ms += 1000000003;
    fprintf(stderr, "mean and std dev: %f +/- %f\n", ms.mean(), ms.standard_deviation());

    benchmark::mean_and_standard_deviation ms2;
    for (int i=0; i<256; i++) {
        ms2 += i;
    }
    fprintf(stderr, "mean and std dev: %f +/- %f\n", ms2.mean(), ms2.standard_deviation());
    ...
    printf("sizeof(encoded<uint32_t>): %zu\n", sizeof(encoded<uint32_t>));
    printf("sizeof(encoded<uint64_t>): %zu\n", sizeof(encoded<uint64_t>));

    printf("sizeof(space): %zu\n", sizeof(space));
    printf("sizeof(digit): %zu\n", sizeof(digit));
    printf("sizeof(literal<5>): %zu\n", sizeof(literal<5>));
    printf("sizeof(acceptor<'x'>): %zu\n", sizeof(acceptor<'x'>));
    printf("sizeof(http::request): %zu\n", sizeof(http::request));
    printf("sizeof(http::http_header): %zu\n", sizeof(http::http_header));
    printf("sizeof(http::headers): %zu\n", sizeof(http::headers));
    printf("sizeof(http::version): %zu\n", sizeof(http::version));
    printf("sizeof(http::request_line): %zu\n", sizeof(http::request_line));
    printf("sizeof(http::method): %zu\n", sizeof(http::method));
    printf("sizeof(http::token): %zu\n", sizeof(http::token));
    printf("sizeof(http::uri_chars): %zu\n", sizeof(http::uri_chars));
    printf("sizeof(http::uppercase): %zu\n", sizeof(http::uppercase));
    //printf("sizeof(): %zu\n", sizeof());
