...
public:
    ...
    void print_as_oid(struct buffer_stream &buf) const {
        if (is_not_readable()) {
...
struct tlv {
    ...
    static bool recursive_parse(datum &d, json_array &a) {
