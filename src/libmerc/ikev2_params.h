// ikev2_params.h
//
// this file autogenerated by csv2cpp at Wed Sep 14 06:38:43 AM EDT 2022
...
template <typename T>
class exchange_type : public encoded<uint8_t> {
...
template <typename T>
class payload_type : public encoded<uint8_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class transform_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class transform_attribute_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class encryption_transform_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class pseudorandom_function_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class integrity_transform_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class diffie_hellman_group_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class extended_sequence_numbers_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class certificate_encoding_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class authentication_method_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class notify_message_error_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class notify_message_status_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class notification_ipcomp_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class security_protocol_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class traffic_selector_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class configuration_payload_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class configuration_payload_attribute_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class gateway_identity_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class rohc_attribute_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class secure_password_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class hash_algorithm_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
...
template <typename T>
class postquantum_preshared_key_type : public encoded<uint16_t> {
    static_assert(std::is_unsigned_v<T>, "T must be an unsigned integer");public:
    void write_json(json_object &o) const {
        const char *name = get_name();
