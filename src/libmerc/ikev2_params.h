// ikev2_params.h
//
// this file was autogenerated at 2022-09-20T17:49:40Z
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("exchange_type_type_code", encoded<T>::value());
        }
    }
    enum code {
        IKE_SA_INIT        = 34,
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("payload_type_type_code", encoded<T>::value());
        }
    }
    enum code {
        No_Next_Payload                      = 0,
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("transform_type_type_code", encoded<T>::value());
        }
    }
    enum code {
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("transform_attribute_type_type_code", encoded<T>::value());
        }
    }
    enum code {
        Key_Length = 14,
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("encryption_transform_type_type_code", encoded<T>::value());
        }
    }
    enum code {
        ENCR_DES_IV64                 = 1,
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("pseudorandom_function_type_type_code", encoded<T>::value());
        }
    }
    enum code {
        PRF_HMAC_MD5          = 1,
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("integrity_transform_type_type_code", encoded<T>::value());
        }
    }
    enum code {
        NONE                   = 0,
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("diffie_hellman_group_type_type_code", encoded<T>::value());
        }
    }
    enum code {
        NONE                                                   = 0,
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("extended_sequence_numbers_type_type_code", encoded<T>::value());
        }
    }
    enum code {
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("identification_payload_type_type_code", encoded<T>::value());
        }
    }
    enum code {
        ID_IPV4_ADDR   = 1,
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("certificate_encoding_type_type_code", encoded<T>::value());
        }
    }
    enum code {
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("authentication_method_type_type_code", encoded<T>::value());
        }
    }
    enum code {
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("notify_message_error_type_type_code", encoded<T>::value());
        }
    }
    enum code {
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("notify_message_status_type_type_code", encoded<T>::value());
        }
    }
    enum code {
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("notification_ipcomp_type_type_code", encoded<T>::value());
        }
    }
    enum code {
        IPCOMP_OUI     = 1,
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("security_protocol_type_type_code", encoded<T>::value());
        }
    }
    enum code {
        IKE                  = 1,
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("traffic_selector_type_type_code", encoded<T>::value());
        }
    }
    enum code {
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("configuration_payload_type_type_code", encoded<T>::value());
        }
    }
    enum code {
        CFG_REQUEST = 1,
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("configuration_payload_attribute_type_type_code", encoded<T>::value());
        }
    }
    enum code {
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("gateway_identity_type_type_code", encoded<T>::value());
        }
    }
    enum code {
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("rohc_attribute_type_type_code", encoded<T>::value());
        }
    }
    enum code {
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("secure_password_type_type_code", encoded<T>::value());
        }
    }
    enum code {
        PACE                      = 1,
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("hash_algorithm_type_type_code", encoded<T>::value());
        }
    }
    enum code {
        SHA1         = 1,
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("postquantum_preshared_key_type_type_code", encoded<T>::value());
        }
    }
    enum code {
        PPK_ID_OPAQUE = 1,
