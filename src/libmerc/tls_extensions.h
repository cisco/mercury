// tls_extensions.h
//
// this file was autogenerated at 2024-02-13T10:59:49Z
...
public:
    ...
    static bool is_unassigned_extension(uint16_t type) {
        return(
             (type >= 62 && type <= 2569)
             || (type >= 2571 && type <= 6681)
             || (type >= 6683 && type <= 10793)
             || (type >= 10795 && type <= 14905)
             || (type >= 14907 && type <= 19017)
             || (type >= 19019 && type <= 23129)
             || (type >= 23131 && type <= 27241)
             || (type >= 27243 && type <= 31353)
             || (type >= 31355 && type <= 35465)
             || (type >= 35467 && type <= 39577)
             || (type >= 39579 && type <= 43689)
             || (type >= 43691 && type <= 47801)
             || (type >= 47803 && type <= 51913)
             || (type >= 51915 && type <= 56025)
             || (type >= 56027 && type <= 60137)
             || (type >= 60139 && type <= 64249)
             || (type >= 64251 && type <= 64767)
             || (type >= 64769 && type <= 65036)
             || (type >= 65038 && type <= 65279)
        );
    }
};
