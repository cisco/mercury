// stun_params.h
//
// this file was autogenerated at 2022-09-20T21:19:30Z
...
template <typename T>
class method_type : public encoded<T> {
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("method_type_code", encoded<T>::value());
        }
    }
    enum code {
        Binding           = 0x001,
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("attribute_type_code", encoded<T>::value());
        }
    }
    enum code {
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("error_codes_code", encoded<T>::value());
        }
    }
    enum code {
        Try_Alternate                  = 300,
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("security_features_code", encoded<T>::value());
        }
    }
    enum code {
...
public:
    void write_json(json_object &o) const {
        ...
        if (name == UNKNOWN) {
            o.print_key_uint("password_algorithms_code", encoded<T>::value());
        }
    }
    enum code {
        MD5     = 0x0001,
