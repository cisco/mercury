std::unordered_map<std::string, std::string> oid_dict = {
	...
	{ {0x2a,0x86,0x48,0xce,0x3d,0x03,0x0f}, "sect163r2" },
	{ {0x2a,0x86,0x48,0xce,0x3d,0x03,0x10}, "sect283k1" },
	{ {0x2a,0x86,0x48,0xce,0x3d,0x03,0x11}, "sect283r1" },
	{ {0x2a,0x86,0x48,0xce,0x3d,0x03,0x1a}, "sect233k1" },
	{ {0x2a,0x86,0x48,0xce,0x3d,0x03,0x1b}, "sect233r1" },
	{ {0x2a,0x86,0x48,0xce,0x3d,0x03,0x1f}, "secp192k1" },
	{ {0x2a,0x86,0x48,0xce,0x3d,0x03,0x20}, "secp224k1" },
	{ {0x2a,0x86,0x48,0xce,0x3d,0x03,0x21}, "secp224r1" },
	{ {0x2a,0x86,0x48,0xce,0x3d,0x03,0x22}, "secp384r1" },
	{ {0x2a,0x86,0x48,0xce,0x3d,0x03,0x23}, "secp521r1" },
	{ {0x2a,0x86,0x48,0xce,0x3d,0x03,0x24}, "sect409k1" },
	{ {0x2a,0x86,0x48,0xce,0x3d,0x03,0x25}, "sect409r1" },
	{ {0x2a,0x86,0x48,0xce,0x3d,0x03,0x26}, "sect571k1" },
	{ {0x2a,0x86,0x48,0xce,0x3d,0x03,0x27}, "sect571r1" },
	...
	{ {0x2b,0x81,0x04,0x00,0x0f}, "sect163r2[1]" },
	{ {0x2b,0x81,0x04,0x00,0x10}, "sect283k1[1]" },
	{ {0x2b,0x81,0x04,0x00,0x11}, "sect283r1[1]" },
	{ {0x2b,0x81,0x04,0x00,0x1a}, "sect233k1[1]" },
	{ {0x2b,0x81,0x04,0x00,0x1b}, "sect233r1[1]" },
	{ {0x2b,0x81,0x04,0x00,0x21}, "secp224r1[1]" },
	{ {0x2b,0x81,0x04,0x00,0x22}, "secp384r1[1]" },
	{ {0x2b,0x81,0x04,0x00,0x23}, "secp521r1[1]" },
	{ {0x2b,0x81,0x04,0x00,0x24}, "sect409k1[1]" },
	{ {0x2b,0x81,0x04,0x00,0x25}, "sect409r1[1]" },
	{ {0x2b,0x81,0x04,0x00,0x26}, "sect571k1[1]" },
	{ {0x2b,0x81,0x04,0x00,0x27}, "sect571r1[1]" },
...
enum oid {
	...
	jurisdictionOfIncorporationLocalityName = 313,
	jurisdictionOfIncorporationStateOrProvinceName = 314,
	jurisdictionOfIncorporationCountryName = 315,
	driveEncryption = 316,
	szOID_CAPICOM = 317,
	...
	street = 479,
	o = 480,
	organizationalUnitName = 481,
	title = 482,
	description = 483,
	searchGuide = 484,
	businessCategory = 485,
	postalAddress = 486,
	postalCode = 487,
	postOfficeBox = 488,
	physicalDeliveryOfficeName = 489,
	telephoneNumber = 490,
	telexNumber = 491,
	teletexTerminalIdentifier = 492,
	facsimileTelephoneNumber = 493,
	x121Address = 494,
	internationalISDNNumber = 495,
	registeredAddress = 496,
	destinationIndicator = 497,
	preferredDeliveryMethod = 498,
	member = 499,
	owner = 500,
	roleOccupant = 501,
	seeAlso = 502,
	...
	givenName = 505,
	initials = 506,
	generationQualifier = 507,
	x500UniqueIdentifier = 508,
	dnQualifier = 509,
	enhancedSearchGuide = 510,
	distinguishedName = 511,
	uniqueMember = 512,
	houseIdentifier = 513,
	id_at_pseudonym = 514,
	id_ce = 515,
	...
	id_ce_subjectAltName = 522,
	id_ce_issuerAltName = 523,
	id_ce_basicConstraints = 524,
	id_ce_cRLNumber = 525,
	id_ce_cRLReasons = 526,
	id_ce_holdInstructionCode = 527,
...
std::unordered_map<std::string, enum oid> oid_to_enum = {
	...
	{ {0x2a,0x86,0x48,0x86,0xf7,0x0d,0x01,0x09,0x0e}, id_ExtensionReq },
	...
	{ {0x2b,0x81,0x04,0x00,0x01}, sect163k1 },
	{ {0x2b,0x81,0x04,0x00,0x0f}, sect163r2_1_ },
	{ {0x2b,0x81,0x04,0x00,0x10}, sect283k1_1_ },
	{ {0x2b,0x81,0x04,0x00,0x11}, sect283r1_1_ },
	{ {0x2b,0x81,0x04,0x00,0x1a}, sect233k1_1_ },
	{ {0x2b,0x81,0x04,0x00,0x1b}, sect233r1_1_ },
	{ {0x2b,0x81,0x04,0x00,0x21}, secp224r1_1_ },
	{ {0x2b,0x81,0x04,0x00,0x22}, secp384r1_1_ },
	{ {0x2b,0x81,0x04,0x00,0x23}, secp521r1_1_ },
	{ {0x2b,0x81,0x04,0x00,0x24}, sect409k1_1_ },
	{ {0x2b,0x81,0x04,0x00,0x25}, sect409r1_1_ },
	{ {0x2b,0x81,0x04,0x00,0x26}, sect571k1_1_ },
	{ {0x2b,0x81,0x04,0x00,0x27}, sect571r1_1_ },
