std::unordered_map<std::basic_string<uint8_t>, std::string> oid_dict = {
	{ {0x04,0x00,0x8f,0x7a,0x01,0x04}, "ETSI_EV_CPS[1]" },
	{ {0x04,0x00,0x8f,0x7a,0x01,0x05}, "ETSI_EV_CPS" },
...
std::unordered_map<std::basic_string<uint8_t>, enum oid> oid_to_enum = {
	{ {0x04,0x00,0x8f,0x7a,0x01,0x04}, ETSI_EV_CPS_1_ },
	{ {0x04,0x00,0x8f,0x7a,0x01,0x05}, ETSI_EV_CPS },
	{ {0x09,0x92,0x26,0x89,0x93,0xf2,0x2c,0x64,0x01,0x01}, user_id },
	{ {0x09,0x92,0x26,0x89,0x93,0xf2,0x2c,0x64,0x01,0x19}, domain_component },
	{ {0x2a}, ISO },
